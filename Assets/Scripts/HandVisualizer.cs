...
/// <summary>
/// Modified HandVisualizer script - it inherits from NetworkBehaviour so it can spawn hands on the server. 
/// See lines 208 and 221 in the Update function.
/// </summary>
...
public class HandVisualizer : NetworkBehaviour
{
    ...
    [SerializeField] UnityEvent<GameObject> onSetHandL;
    [SerializeField] UnityEvent<GameObject> onSetHandR;
    ...
    protected void Update()
    {
        ...
        if (m_LeftHandGameObjects == null)
        {
            m_LeftHandGameObjects = new HandGameObjects(
                ...
                m_DebugDrawPrefab,
                m_VelocityPrefab);
            onSetHandL.Invoke(m_LeftHandGameObjects.m_HandRoot);
            NetworkServer.Spawn(m_LeftHandGameObjects.m_HandRoot); //spawns object for all clients
        }
        ...
        if (m_RightHandGameObjects == null)
        {
            m_RightHandGameObjects = new HandGameObjects(
                ...
                m_DebugDrawPrefab,
                m_VelocityPrefab);
            onSetHandR.Invoke(m_RightHandGameObjects.m_HandRoot);
            NetworkServer.Spawn(m_RightHandGameObjects.m_HandRoot); //spawns object for all clients
        }
